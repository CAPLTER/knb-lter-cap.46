...
bird_observations <- bird_observations |>
  dplyr::filter(survey_date <= "2021-03-01")
...
coverage <- EML::set_coverage(
  ...
  west                  = sf::st_bbox(bird_survey_locations)[["xmin"]],
  east                  = sf::st_bbox(bird_survey_locations)[["xmax"]],
  north                 = sf::st_bbox(bird_survey_locations)[["ymax"]],
  south                 = sf::st_bbox(bird_survey_locations)[["ymin"]]
)
