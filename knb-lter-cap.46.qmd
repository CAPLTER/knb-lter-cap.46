...
```{r isolate-SRBP-core-site-surveys, eval=TRUE}
...
bird_observations <- bird_observations |>
  dplyr::filter(survey_date <= "2023-06-13")
...
```{r bird-observations-DT, eval=FALSE}
